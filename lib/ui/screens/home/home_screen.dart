...
import 'package:app_flutter_demo/widgets/background_custom.dart' show BackgroundCustom;
      ...
      body: Stack(
        children: [
          ...
          Positioned.fill(
            child: Padding(
              padding:
                  EdgeInsets.symmetric(horizontal: paddingCustom(context)),
              child: Column(
                ...
                children: [
                  ...
                  ButtonCustom(onTap: () {  },title: 'Bắt Đầu thực hành',),
                ],
              ),
            ),
          ),
